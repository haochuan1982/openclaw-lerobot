...
if [[ -z "${CONDA_BIN}" ]]; then
  echo "Error: conda executable not found in ~/miniconda3/bin/conda or ~/anaconda3/bin/conda or ~/miniforge3/bin/conda" >&2
  exit 1
fi
